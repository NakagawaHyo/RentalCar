...
namespace RentalCar.Application.Controllers
{
	public class AuthController : Controller
	{
		...
		public async Task<IActionResult> Login(Login request)
		{
			...
			var user = await _usersService.FindUserAsync(request.LoginId, _usersService.GetSha256Hash(request.Password));
		...
		public async Task<IActionResult> Register(Register request)
		{
			...
			var existingUser = await _usersService.FindUserByLoginIdAsync(request.LoginId);
			...
			var user = await _usersService.FindUserAsync(newUser.LoginId, newUser.Password);
